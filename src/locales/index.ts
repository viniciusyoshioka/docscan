...
function getDeviceLanguage(): string {
  switch (Platform.OS) {
    case "android":
      return normalizedLanguageCode[NativeModules.I18nManager.localeIdentifier]
    case "ios":
      return normalizedLanguageCode[NativeModules.SettingsManager.settings.AppleLocale]
    default:
