...
describe.each([false, true])(
  ...
  hasSeconds => {
    ...
    describe("formatDate", () => {
      it(
        `should format the date correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the date correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
      ...
      it(
        `should format the date correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
    ...
    describe("formatTime", () => {
      it(
        `should format the time correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the time correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
          const timestamp = customDateTime.getTime()
      ...
      it(
        `should format the time correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
    ...
    describe("formatDateTime", () => {
      it(
        `should format the datetime correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the datetime correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
          const timestamp = customDateTime.getTime()
      ...
      it(
        `should format the datetime correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
    ...
    describe("getLocaleDate", () => {
      it(
        `should format the locale date correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the locale date correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
          const timestamp = customDateTime.getTime()
      ...
      it(
        `should format the locale date correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
    ...
    describe("getLocaleTime", () => {
      it(
        `should format the locale time correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the locale time correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
          const timestamp = customDateTime.getTime()
      ...
      it(
        `should format the locale time correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
    ...
    describe("getLocaleDateTime", () => {
      it(
        `should format the locale datetime correctly with hasSeconds=${hasSeconds} using current date`,
        () => {
      ...
      it(
        `should format the locale datetime correctly with hasSeconds=${hasSeconds} passing timestamp`,
        () => {
          const timestamp = customDateTime.getTime()
      ...
      it(
        `should format the locale datetime correctly with hasSeconds=${hasSeconds} passing Date object`,
        () => {
