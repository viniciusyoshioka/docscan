  ...
  describe('getLocaleDate', () => {
    ...
    localesData.forEach(({ locale, value, error }) => {
      ...
      it(`should handle ${stringifiedLocale} using timestamp`, () => {
        ...
        if (error === true) {
          expect(() => dateFormatter.getLocaleDate(timestamp))
            .toThrow(RangeError)
          return
        }
      ...
      it(`should handle ${stringifiedLocale} using date object`, () => {
        if (error === true) {
          expect(() => dateFormatter.getLocaleDate(dateObject))
            .toThrow(RangeError)
          return
        }
  ...
  describe('getLocaleTime', () => {
    ...
    localesData.forEach(({ locale, value, error }) => {
      ...
      it(`should handle ${stringifiedLocale} using timestamp`, () => {
        ...
        if (error === true) {
          expect(() => {
            dateFormatter.getLocaleTime(timestamp)
          }).toThrow(RangeError)
          return
        }
      ...
      it(`should handle ${stringifiedLocale} using date object`, () => {
        if (error === true) {
          expect(() => {
            dateFormatter.getLocaleTime(dateObject)
          }).toThrow(RangeError)
          return
        }
  ...
  describe('getLocaleDateTime', () => {
    ...
    localesData.forEach(({ locale, value, error }) => {
      ...
      it(`should handle ${stringifiedLocale} using timestamp`, () => {
        ...
        if (error === true) {
          expect(() => {
            dateFormatter.getLocaleDateTime(timestamp)
          }).toThrow(RangeError)
          return
        }
      ...
      it(`should handle ${stringifiedLocale} using date object`, () => {
        if (error === true) {
          expect(() => {
            dateFormatter.getLocaleDateTime(dateObject)
          }).toThrow(RangeError)
          return
        }
