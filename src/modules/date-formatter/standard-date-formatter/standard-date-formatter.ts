...
import type { DateFormatter } from '../date-formatter.interface.ts'
import type { DateTimeSeparators, StandardDateFormatterOptions } from './standard-date-formatter.types.ts'
...
export class StandardDateFormatter implements DateFormatter {
  ...
  private parseDate(date?: ParsableDate): Date {
    ...
    if (typeof date === 'string') {
      ...
      const timeAfterTimezoneCorrection = (
        parsedDate.getTime() - timezoneOffsetInMs
      )
